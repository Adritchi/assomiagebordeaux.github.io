...
const handleEditSubmit = async () => {
    try {
        ...
        if (updatedEvent.titre.trim() === '' || updatedEvent.lieu.trim() === '' || updatedEvent.date_debut.trim() === '' || updatedEvent.date_fin.trim() === '' || updatedEvent.description.trim() === '' || updatedEvent.lien.trim() === '') {
            setError(true);
